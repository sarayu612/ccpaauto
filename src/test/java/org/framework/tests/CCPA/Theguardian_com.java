...
public class Theguardian_com extends BaseClass {

	String siteName = "https://www.theguardian.com/";
	String param = ConfigurationReader.getProperty("param");
	String environment = System.getenv("environment");
	String version = System.getenv("version");
	String rejectAction = "Do not sell my personal information";
	String pmOption = "California resident – Do Not Sell";
