...
public class Macworld_com extends BaseClass {

	String siteName = "https://www.macworld.com/";
	String param = ConfigurationReader.getProperty("param");
	String environment = System.getenv("environment");
	String version = System.getenv("version");
	String acceptOption = "I understand/true";
	String pmOption = "Do Not Sell My Personal Info";
